    ...
    return (
        <div className="w-full bg-slate-100 min-h-screen">
            ...
            <div className="relative w-full min-h-screen flex flex-col justify-center items-center bg-slate-50 md:py-0 py-0">
                {/* Responsive Container: Fixed height on Desktop AND Mobile for consistency */}
                <div className="relative w-full max-w-[1280px] h-[85dvh] md:h-[720px] bg-white md:shadow-2xl shadow-xl md:rounded-xl rounded-none overflow-hidden border-0 md:border border-slate-200 z-10 mx-0 md:mx-4 flex flex-col">
                    ...
                    <div className="absolute top-4 md:top-8 z-50 w-full flex justify-center px-4 pointer-events-none">
                        <div className="bg-white/90 backdrop-blur-xl border border-white/50 p-1.5 rounded-2xl shadow-2xl flex items-center gap-1 md:gap-2 pointer-events-auto ring-1 ring-black/5">
                            {[
                    ...
                    <button
                        onClick={prevSlide}
                        className="absolute left-2 md:left-6 top-1/2 -translate-y-1/2 p-2 md:p-3 bg-white/80 backdrop-blur-sm rounded-full text-gray-700 shadow-xl hover:bg-white hover:scale-110 transition-all z-40 border border-gray-100"
                    >
                        <ChevronLeft size={20} className="md:w-6 md:h-6" />
                    </button>
                    <button
                        onClick={nextSlide}
                        className="absolute right-2 md:right-6 top-1/2 -translate-y-1/2 p-2 md:p-3 bg-white/80 backdrop-blur-sm rounded-full text-gray-700 shadow-xl hover:bg-white hover:scale-110 transition-all z-40 border border-gray-100"
                    >
