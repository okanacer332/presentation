...
const ProblemSlide = () => {
    return (
        <div className="slide-content h-full flex flex-col justify-center bg-white text-[#1D1D1F] p-8 relative overflow-hidden">
            ...
            <div className="text-center mb-10 z-10">
                ...
                >
                    Ofiste <strong>Windows</strong>, evde <strong>Mac</strong>, sunucuda <strong>Linux</strong>. <br />
                ...
                <motion.div
                    ...
                    className="flex justify-center items-center gap-6 mt-8 p-4 bg-gray-50 rounded-2xl w-fit mx-auto border border-gray-100"
                >
                    <div className="flex items-center gap-2 text-gray-600 font-medium">
                        <div className="bg-white p-2 rounded border border-gray-200"><Download size={18} /></div>
                        <span className="text-sm">İndir & Kur</span>
                    </div>
                    <div className="w-8 h-px bg-gray-300"></div>
                    <div className="flex items-center gap-2 text-gray-600 font-medium">
                        <div className="bg-white p-2 rounded border border-gray-200"><Smartphone size={18} /></div>
                        <span className="text-sm">Telegram'ı Bağla</span>
                    </div>
                    <div className="w-8 h-px bg-gray-300"></div>
                    <div className="flex items-center gap-2 text-blue-600 font-bold">
                        <div className="bg-blue-100 p-2 rounded border border-blue-200"><MessageCircle size={18} /></div>
                        <span className="text-sm">Konuşmaya Başla</span>
                    </div>
                </motion.div>
            </div>

            {/* Comparison: Static vs Connected */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto w-full z-10">
                ...
                <motion.div
                    ...
                    className="bg-gray-50 border-2 border-dashed border-gray-300 p-8 rounded-3xl flex flex-col justify-center relative group hover:bg-gray-100 transition-colors"
                >
                    <div className="absolute top-4 right-4 text-xs font-bold text-gray-400 bg-gray-200 px-2 py-1 rounded">ESKİ DÜNYA</div>
                    <h3 className="text-2xl font-bold text-gray-600 mb-2">Klasik Yazılımlar</h3>
                    ...
                    <div className="flex flex-col gap-3">
                        <div className="flex items-center gap-3 bg-white p-3 rounded-lg border border-gray-200 opacity-70">
                            ...
                            <span className="text-gray-500 text-sm">Tek tek dosya seç/yükle hamallığı.</span>
                        </div>
                        <div className="flex items-center gap-3 bg-white p-3 rounded-lg border border-gray-200 opacity-70">
                            <HardDrive size={20} className="text-red-400" />
                            <span className="text-gray-500 text-sm">Pasif arşiv (Sizi uyarmaz, yönlendirmez).</span>
                        </div>
                    </div>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="bg-white border-2 border-blue-500 p-8 rounded-3xl flex flex-col shadow-2xl relative overflow-hidden ring-4 ring-blue-50"
                >
                    <div className="absolute top-0 right-0 w-40 h-40 bg-blue-500/10 rounded-full blur-3xl -mr-10 -mt-10"></div>
                    <div className="absolute top-4 right-4 text-xs font-bold text-blue-600 bg-blue-100 px-2 py-1 rounded">YENİ NESİL</div>

                    <h3 className="text-2xl font-bold text-[#1D1D1F] mb-2">Domizan Ekosistemi</h3>
